      ...
      <div className="max-w-5xl mx-auto bg-white shadow-xl rounded-2xl p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-center">
            <button className="w-full md:w-64 bg-[#6F5FE7] hover:bg-[#5b4ec2] text-white font-semibold rounded-xl py-3.5 transition-all transform active:scale-[0.98] shadow-lg">
              Deposit
            </button>
          </div>
