...
export default function LoginPage() {
  ...
  return (
    <>
      {/* ✅ Same Premium Logo as Registration */}
      <PayZenLogo />
      ...
      <div className="min-h-screen bg-gradient-to-br from-[#021029] via-[#051e47] to-[#0A2A66] flex items-center justify-center px-4 sm:px-6">
        ...
        <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 sm:p-8 shadow-2xl">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-zinc-400 text-sm mt-2">Access your banking dashboard safely</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <div className="flex justify-between items-center text-sm">
              ...
              <span
                className="text-[#6F5FE7] cursor-pointer hover:underline"
          ...
          <div className="mt-6 text-center">
            <p className="text-zinc-400 text-sm">
              ...
              <button
                ...
                className="text-[#6F5FE7] font-semibold hover:underline"
              >
                Register here
              </button>
            </p>
