  ...
  return (
    <div style={{ position: "fixed", inset: 0, zIndex: 0, pointerEvents: "none" }}>
      ...
      <div style={{
        ...
        background: `
          radial-gradient(ellipse 70% 50% at 20% 50%, rgba(124,58,237,0.22) 0%, transparent 60%),
          radial-gradient(ellipse 50% 70% at 80% 20%, rgba(168,85,247,0.18) 0%, transparent 55%),
          radial-gradient(ellipse 40% 40% at 60% 85%, rgba(139,92,246,0.1) 0%, transparent 50%)`
      }} />
      <div style={{
        position: "absolute", inset: 0,
      ...
      <div style={{
        position: "absolute", inset: 0,
        backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(80,0,255,0.015) 2px, rgba(80,0,255,0.015) 4px)",
        mixBlendMode: "screen"
      }} />
    </div>
  );
...
function Particles() {
  const pts = [
    { s:3, t:"8%",  l:"5%",  c:"#818cf8", d:"3.2s", dl:"0s"   },
    { s:2, t:"20%", l:"88%", c:"#a78bfa", d:"2.8s", dl:"0.7s" },
    { s:4, t:"65%", l:"8%",  c:"#d8b4fe", d:"3.5s", dl:"1.2s" },
    { s:2, t:"82%", l:"80%", c:"#818cf8", d:"2.3s", dl:"0.4s" },
    { s:3, t:"42%", l:"2%",  c:"#a855f7", d:"3.8s", dl:"1.8s" },
    { s:2, t:"10%", l:"50%", c:"#818cf8", d:"2.6s", dl:"0.9s" },
    { s:3, t:"92%", l:"35%", c:"#a78bfa", d:"3.1s", dl:"1.5s" },
    { s:2, t:"30%", l:"92%", c:"#d8b4fe", d:"2.9s", dl:"0.2s" },
    { s:4, t:"55%", l:"96%", c:"#818cf8", d:"3.3s", dl:"2.1s" },
    { s:2, t:"75%", l:"52%", c:"#a855f7", d:"2.7s", dl:"0.6s" },
  ];
  return (
      ...
      <div style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", alignItems: "center", animation: "logoIn 1s cubic-bezier(.16,1,.3,1) both .3s" }}>
        <div style={{ position: "relative", marginBottom: 28, animation: "hexFloat 5s ease-in-out infinite" }}>
          <div style={{
            ...
            background: "radial-gradient(circle, rgba(124,58,237,0.6) 0%, transparent 65%)",
            filter: "blur(18px)", animation: "ambPulse 3s ease-in-out infinite",
          }} />
          <svg width="100" height="100" viewBox="0 0 100 100" fill="none">
            <path d="M50 4 L90 26 L90 74 L50 96 L10 74 L10 26 Z" fill="rgba(29,78,216,0.2)" stroke="url(#hsA)" strokeWidth="1.5" />
            <path d="M50 16 L80 32 L80 68 L50 84 L20 68 L20 32 Z" fill="rgba(37,99,235,0.1)" stroke="rgba(56,189,248,0.35)" strokeWidth="1" />
            <text x="50" y="63" fontFamily="Georgia,serif" fontSize="34" fontWeight="900" fill="url(#tgA)" textAnchor="middle">P</text>
            {[[50,4],[90,26],[90,74],[50,96],[10,74],[10,26]].map(([x,y],i) => (
              <circle key={i} cx={x} cy={y} r="2.5" fill="rgba(56,189,248,0.9)" />
            ))}
            <defs>
              <linearGradient id="hsA" x1="10" y1="4" x2="90" y2="96" gradientUnits="userSpaceOnUse">
                <stop offset="0%" stopColor="rgba(56,189,248,0.9)" />
                <stop offset="50%" stopColor="rgba(129,140,248,0.6)" />
                <stop offset="100%" stopColor="rgba(56,189,248,0.9)" />
              </linearGradient>
              <linearGradient id="tgA" x1="0" y1="0" x2="0" y2="70" gradientUnits="userSpaceOnUse">
        ...
        <p style={{ fontSize: 11, fontWeight: 500, letterSpacing: "0.3em", textTransform: "uppercase", color: "rgba(180,210,255,0.45)", marginBottom: 28, opacity: 0, animation: "fadeUp .7s ease both 1.2s" }}>Admin Portal</p>
        <p style={{ fontSize: 14, fontWeight: 300, textAlign: "center", lineHeight: 1.8, maxWidth: 240, color: "rgba(180,210,255,0.5)", opacity: 0, animation: "fadeUp .7s ease both 1.4s" }}>
          Secure admin access <br />for authorized personnel only.
        </p>
...
function MobileLogo() {
  return (
    <div className="lg-hide-logo" style={{ flexDirection: "column", alignItems: "center", marginBottom: 20 }}>
      ...
      <p style={{ fontSize: 9, letterSpacing: "0.3em", textTransform: "uppercase", color: "rgba(180,210,255,0.4)", marginTop: 3 }}>Admin Portal</p>
    </div>
  );
}
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  ...
                  <div>
                    <label style={{ display: "block", fontSize: 11, fontWeight: 600, color: "rgba(148,163,184,0.8)", marginBottom: 7, letterSpacing: "0.05em" }}>
                      Admin Email <span style={{ color: "#f87171" }}>*</span>
                    </label>
                    <div style={{ position: "relative" }}>
                      ...
                      <input type="email" name="email" placeholder="admin@payzen.com"
